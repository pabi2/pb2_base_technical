...
class NstdaconfReportParser(report_sxw):
    ...
    def generate_pdf(self, cr, uid, ids, data, report_xml):
        ...
        config_parameter_prefix_path = ir_config.get_param(cr, uid, 'nstdaconf_report.jaster_prefix_path')
        ...
        host_new = config_parameter_prefix_path + "/" + host_new
...
#             config_password = model_obj.jasper_password
        ...
        #rp_path = "/Reports/o_test_28003_intra_nstda_or_th/nstda_gnc"
        ...
        if url and user and password and report_path:
            ...
            if a:
                if 'data' in a:
                    ...
                    raise osv.except_osv(_('Error !'), a)
            else:
                raise osv.except_osv(_('Error !'), _('Report Error View to log.'))
        else:
